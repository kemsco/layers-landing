...
export default function FinalCTA() {
  return (
    <section style={{ padding: "140px 24px 80px", background: "#000", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", bottom: -80, left: "50%", transform: "translateX(-50%)", width: 800, height: 500, background: "radial-gradient(ellipse at 50% 100%, rgba(255,255,255,0.05) 0%, transparent 65%)", pointerEvents: "none" }} />
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}
          ...
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 16px", borderRadius: 99, fontSize: 11, border: "1px solid rgba(255,255,255,0.1)", background: "rgba(255,255,255,0.03)", color: "#555", fontFamily: B, letterSpacing: "0.02em" }}>
        ...
        <motion.h2 initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.1 }}
          ...
          <br /><span style={{ color: "#2a2a2a" }}>leur offre GEO maintenant.</span>
        </motion.h2>

        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.2 }}
          style={{ fontSize: 16, color: "#4a4a4a", lineHeight: 1.75, maxWidth: 560, margin: "0 auto 52px", fontFamily: B }}>
